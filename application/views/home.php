...
<!-- Mirrored from htmldemo.net/zaya/zaya/shop-4-columns.html by HTTrack Website Copier/3.x [XR&CO'2010], Tue, 18 Jul 2023 18:00:52 GMT -->
                ...
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <div class="header__main--logo">
                            <a class="justify-content-center justify-content-xl-start" href="index.html"><img src="assets/images/logo.svg" alt="Logo" /></a>
                        </div>
                    </div>
        ...
        <div class="offcanvas-body">
            <ul class="offcanvas-cart-list">
                <li>
                    ...
                    <div class="offcanvas-cart-item">
                        <div class="offcanvas-cart-item__thumbnail">
                            <a href="#"><img src="assets/images/products/product-13.jpg" alt="product" /></a>
                        </div>
                ...
                <li>
                    ...
                    <div class="offcanvas-cart-item">
                        <div class="offcanvas-cart-item__thumbnail">
                            <a href="#"><img src="assets/images/products/product-14.jpg" alt="product" /></a>
                        </div>
                        <div class="offcanvas-cart-item__content">
                            <h4 class="offcanvas-cart-item__title">
                ...
                <li>
                    ...
                    <div class="offcanvas-cart-item">
                        <div class="offcanvas-cart-item__thumbnail">
                            <a href="#"><img src="assets/images/products/product-17.jpg" alt="product" /></a>
                        </div>
                        <div class="offcanvas-cart-item__content">
                            <h4 class="offcanvas-cart-item__title">
    ...
    <main>
        ...
        <div class="shop-section section-padding-2">
            <div class="container-fluid custom-container">
                ...
                <div class="shop-filter">
                    ...
                    <div class="shop-filter-default justify-content-center">
                        ...
                        <div class="shop-filter-dropdown dropdown">
                            ...
                            <!-- widget Item Start -->
                            <div class="">
                                <select class="category form-select" aria-label="">
                ...
                <div class="text-center">
                    <a href="#" class="btn product-view-btn">Load More Products</a>
                </div>
        ...
        <div class="newsletter-section-2">
            ...
            <div class="newsletter-right" style="
                ...
                <div class="newsletter-wrapper newsletter-wrapper--2 text-center">
                    <h4 class="newsletter-wrapper__title">
            ...
            <div class="footer-main align-items-center">
                <div class="footer-left-2">
                    <div class="footer-about text-lg-start text-center">
                        <a class="logo justify-content-lg-start justify-content-center" href="#"><img src="assets/images/logo-white.svg" alt="Logo" /></a>
                        <p>
                                    ...
                                    <div class="swiper">
                                        <div class="swiper-wrapper">
                                            <div class="product-single-slide-item swiper-slide">
                                                <img src="assets/images/products/woman/product-03-a.jpg" />
                                            </div>
                                            <div class="product-single-slide-item swiper-slide">
                                                <img src="assets/images/products/woman/product-03-b.jpg" />
                                            </div>
                                            <div class="product-single-slide-item swiper-slide">
                                                <img src="assets/images/products/woman/product-03-c.jpg" />
                                            </div>
                                            <div class="product-single-slide-item swiper-slide">
                                                <img src="assets/images/products/woman/product-03-d.jpg" />
                                            </div>
                                        </div>
                ...
                if (category) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            console.log(data);
                            $(document).find('.filtered-products').html(data);
                            // var html = $.parseHTML(data);
                            // $('.filtered-products').html('<p>asdfadfasdfasdfadf adfasdfasasdfasd adsfasdfas asdfasdfasdas</p>');
                        }
                    });
                }
            });
